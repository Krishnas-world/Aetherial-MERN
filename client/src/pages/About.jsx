        ...
        <div className="container">
          <div className="row align-center">
            <div className="col-md-12 text-center"><br/>
              <h2 className='section-title text-white text-9xl text-center' style={{font:'Montserrat'}}>ABOUT US</h2><br/>
            ...
            <div className='col-sm-6 col-md-4 transition ease-in-out delay-150 bg-white hover:-translate-y-1 hover:scale-110 hover:bg-white-500 duration-300 size-[20rem] rounded-lg '>
              <div className='team-item '>
                <img src='../../public/navneet-min.jpeg'className='team-img rounded-full' alt='picture'/>
            ...
            <div className='col-sm-6 col-md-4 transition ease-in-out delay-150 bg-white hover:-translate-y-1 hover:scale-110 hover:bg-white-500 duration-300 size-[20rem] rounded-lg '>
              <div className='team-item'>
                <img src='../../public/Anirudh-min.jpeg' className='team-img' alt='picture'/>
                <h3>Anirudha Udupa</h3>
                <div className='team-info'>
                  <p>Team Lead</p>
            ...
            <div className='col-sm-6 col-md-4 transition ease-in-out delay-150 bg-white hover:-translate-y-1 hover:scale-110 hover:bg-white-500 duration-300 size-[20rem] rounded-lg '>
              <div className='team-item'>
                <img src='../../public/logo.jpg' className='team-img' alt='picture'/>
                <h3>Krishna H Pallan</h3>
                <div className='team-info'>
                  <p>Team Lead</p>
            ...
            <div className='col-sm-6 col-md-4 transition ease-in-out delay-150 bg-white hover:-translate-y-1 hover:scale-110 hover:bg-white-500 duration-300 size-[20rem] rounded-lg '>
              <div className='team-item'>
                <img src='../../public/jonathan.jpg' className='team-img' alt='picture'/>
                <h3>Anirudha Udupa</h3>
                <div className='team-info'>
                  <p>Team Lead</p>
                  <ul className='team-icon display: inline-flex flex-row'>
